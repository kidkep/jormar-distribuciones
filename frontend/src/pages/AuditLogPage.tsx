    ...
    <div className="space-y-6">
      <div className="flex animate-fade-up items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">Consulta el historial de cambios del sistema</p>
        </div>
        <button
          onClick={() => refetch()}
      ...
      <div className="animate-fade-up-delay-1 grid grid-cols-1 gap-3 sm:grid-cols-3">
        ...
        <table className="table-premium w-full text-left text-sm">
          <thead className="text-xs uppercase">
            <tr>
              ...
              <th className="px-5 py-3">Detalle del cambio</th>
            </tr>
          </thead>
              ...
              logs.map((log: AuditLogEntry) => {
                ...
                return (
                  <tr key={log.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-5 py-3.5">{log.full_name || log.username || "-"}</td>
                    ...
                    <td className="max-w-md px-5 py-3.5 text-xs text-gray-600">{detail}</td>
                  </tr>
                );
              })
            )}
